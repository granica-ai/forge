...
**Tags** (e.g. `v0.9.2-rc1-delta-version-fix`) are the supported contract. `main` is updated with each release.
...
```bash
export FORGE_VERSION=v0.9.2-rc1-delta-version-fix
...
```bash
export FORGE_VERSION=v0.9.2-rc1-delta-version-fix   # your release tag
...
```bash
export FORGE_VERSION=v0.9.2-rc1-delta-version-fix   # replace with your tag
kubectl apply -f "https://raw.githubusercontent.com/granica-ai/forge/${FORGE_VERSION}/operator/install.yaml"
```
