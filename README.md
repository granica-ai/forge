...
**Tags** (e.g. `v1.0.0-rc1`) are the supported contract. `main` is updated with each release.
...
```bash
export FORGE_VERSION=v1.0.0-rc1
...
```bash
export FORGE_VERSION=v1.0.0-rc1   # your release tag
...
```bash
export FORGE_VERSION=v1.0.0-rc1   # replace with your tag
kubectl apply -f "https://raw.githubusercontent.com/granica-ai/forge/${FORGE_VERSION}/operator/install.yaml"
```
