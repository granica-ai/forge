...
```bash
git clone --depth 1 --branch v0.9.2-rc1-delta-version-fix https://github.com/granica-ai/forge.git
...
# release_version          = "v0.9.2-rc1-delta-version-fix"      # Forge release (templated at publish)
