...
```bash
git clone --depth 1 --branch v0.9.2-rc1-commit-protocol-fix https://github.com/granica-ai/forge.git
...
# release_version          = "v0.9.2-rc1-commit-protocol-fix"      # Forge release (templated at publish)
